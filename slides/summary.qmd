...
:::: {.columns}
::: {.column width="50%"}
![Single general factor](figures/sem_g.png)
:::
::: {.column width="50%"}
![Three theory factors — but inter-factor r ≈ 0.85–0.96](figures/sem_3factor.png)
:::
::::

The 3-factor model fits slightly better than *g*, but the factors are so highly correlated that it is effectively **one general factor with weakly-separable domains**.

...
- **Local SEM:** verbal/reading pull away from the fluid core with age (broad fluid–verbal 0.93 → 0.83; narrower factor pairs separate more sharply).
...
- A **~16-min, 4-task screener** recovers the broad fluid/verbal split at ≈ 0.90.
...
- **Two weak strands**: a **speeded-task factor** (ROAR-Word/Sentence, Hearts & Flowers) + a weaker untimed-cognitive one — *not* one general trait.
- The **speeded factor** is the real one: declines with age (r ≈ −0.42) and is the most longitudinally stable (H&F test–retest 0.47).
- **Site:** Bogotá markedly more RT-variable than Leipzig (+0.28 / +0.33 SD, age-adjusted) — admin medium / setting / population.
...
- **De-confounding** (excess-over-independence / lag-1 autocorrelation) collapses reliability & stability to ~0 — robust to the baseline (observed-*p* **or** theta-IRF).
- No separable accuracy-instability trait. **Contrast:** RT keeps real signal beyond mean RT; accuracy keeps none beyond accuracy level.
